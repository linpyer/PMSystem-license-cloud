...
@pytest.mark.parametrize("status", [LicenseStatus.ACTIVE, LicenseStatus.VERIFY_RECOMMENDED, LicenseStatus.OFFLINE_GRACE])
...
@pytest.mark.parametrize("status", [LicenseStatus.UNLICENSED, LicenseStatus.RESTRICTED, LicenseStatus.EXPIRED, LicenseStatus.DISABLED, LicenseStatus.REVOKED])
