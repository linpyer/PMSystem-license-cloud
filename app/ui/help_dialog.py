...
HELP_TABS: list[tuple[str, str]] = [
    (
        ...
        <li>确认摄像头画面正常显示。</li>
        <li>使用扫码枪扫描单号后，系统会自动开始录制。</li>
        <li>录制中，视频画面会写入单号和当前日期时间水印。</li>
        <li>录制中预览画面会实时显示单号和当前日期时间，方便确认最终视频效果。</li>
        <li>再次扫描新的单号时，系统会自动结束上一个视频，并立即开始新单号的视频录制。</li>
    ...
    (
        ...
        <li>如果同一个单号存在多条视频记录，文件状态列会显示“正常”和“重复第 N 次”标签。</li>
        </ol>
        """,
    ),
    (
    ...
    (
        ...
        <li>水印字号：用于设置视频中单号和日期时间水印的文字大小。</li>
